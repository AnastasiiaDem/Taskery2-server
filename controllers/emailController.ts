...
export const sendEmail = async (
  ...
  if (!foundUser)
    return res.status(409).json({ message: `Incorrect password or email` });
  ...
  if (content == "task") {
    ...
    html =
      ...
      task.status +
      "</b></p>\n" +
      '    <p style="text-align: left;">Task description: <br><p style="margin-left: 50px;">' +
      task.description +
      "</p></p>\n" +
      "    <p>Task deadline: <b>" +
      task.deadline +
    ...
    html =
      ...
      report.status +
      "</b></p>\n" +
      "    <p>Project start Date: <b>" +
      report.projectStart +
      "</b></p>\n" +
      "    <p>Number of tasks: <b>" +
      report.numberOfTasks +
      "</b></p>\n" +
      "    <p>Number of overdue tasks: <b>" +
      report.overdueTasks +
      "</b></p>\n" +
      "  </div>";
    ...
    html =
      ...
      project.projectName +
      "</b></p>\n" +
      '    <p style="text-align: left;">Project description: <br><p style="margin-left: 50px;">' +
      project.description +
      "</p></p>\n" +
      "    <p>Project status: <b>" +
      project.status +
      "</b></p>\n" +
      '    <p>All assigned employees for this project: <p style="margin-left: 50px;">' +
      assignedList +
      "</p></p>\n" +
      "  </div>";
  }
